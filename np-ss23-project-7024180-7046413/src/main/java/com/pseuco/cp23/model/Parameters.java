...
public class Parameters {
     ...
     *
     * @param coughThreshold      The threshold determining how often a person coughs.
     * @param breathThreshold     The threshold determining how often a person breaths.
     * @param accelerationDivisor The divisor determining how likely a person is to
     *                            accelerate.
     * @param recoveryTime        The number of ticks a person is infectious before
     *                            recovering.
     * @param infectionRadius     The maximum (non-diagonal) distance the infection can spread
     *                            directly.
     * @param incubationTime      The number of ticks a person is infected before becoming
     *                            infectious.
     */
    @JsonCreator
    public Parameters(
